...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    confirmeBtn.addEventListener('click', async () => {
        ...
        confirmeBtn.innerHTML = `<span class="spinner"></span> جاري الحذف...`;
        confirmeBtn.disabled = true;
        const carId = confirmeBtn.dataset.id;
        ...
        try {
            ...
            if (data.ok) {
                ...
                showToast("فشل حذف السياره يرجى إعادة المحاولة لاحقا", "error");
            }
        } catch (error) {
